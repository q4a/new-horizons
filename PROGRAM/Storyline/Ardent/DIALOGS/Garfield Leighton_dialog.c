...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "abduction_still_here":
			if (pirate_relation == RELATION_FRIEND)
			{
				if (PChar.sex == "man") PreProcessor_Add("ladlass", "lad");
				else PreProcessor_Add("ladlass", "lass");
		...
		case "abduction_rescue_done":
			...
			if (PChar.sex == "man")
			{
				PreProcessor_Add("person", "woman");
				Preprocessor_Add("kid", "daughter");
			}
			else
			{
				PreProcessor_Add("person", "man");
				Preprocessor_Add("kid", "son");
			}
			if (pirate_relation == RELATION_FRIEND)
			{
