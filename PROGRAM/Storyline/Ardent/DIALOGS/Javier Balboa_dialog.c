void ProcessDialogEvent()
{
	ref NPChar;
	aref Link, NextDiag;
	string gov_kid, merch_kid, name, offer, gov_kid_pronoun, gov_kid_pronoun2, merch_kid_pronoun;
	int x, y;
...
//			PChar.quest.marriage.money = 200000;
		...
		case "convoy_return":
			...
			else name = "Capitan " + GetMyLastName(PChar);
